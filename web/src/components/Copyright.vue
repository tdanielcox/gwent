<template>
    <div class="copyright">
        ...
        <p>This website was created solely for educational purposes, all code is open source and available for free.</p>

        <p><a href="https://github.com/tdanielcox/gwent">View the source code on Github</a></p>
    </div>
</template>
